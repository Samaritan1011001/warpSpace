...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    ...
    window.navigator.getUserMedia(video: true).then((MediaStream stream) {
     ...
     _img = ImageCapture(stream.getVideoTracks()[0]);
      ...
      body: Center(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () async {
            ...
            var event = _webcamVideoElement.srcObject.active ? _webcamVideoElement.play() : null;
            var frame = await _img.takePhoto();
            print(frame.slice());
//            ui.instantiateImageCodec(frame)
          },
